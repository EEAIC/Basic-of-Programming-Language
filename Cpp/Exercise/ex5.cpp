...
다음 조건과 같인 width와 height의 값을 바꿀수 있도록 하세요.
...
public:
	GameWindow();
	GameWindow(int, int); //GameWindow(const int, const int);
...
*/
int GameWindow::GetWidth() { return width; } //int GameWindow::GetWidth() const { return width; }
int GameWindow::GetHeight() { return height; } //int GameWindow::GetHeight() const { return height; }
